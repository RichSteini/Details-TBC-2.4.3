	...
	elseif (event == "ADDON_LOADED") then
		...
		if (AddonName == "Details_TinyThreat") then
			...
			if (_G._detalhes) then
				...
				--> Install
				local install, saveddata = _G._detalhes:InstallPlugin ("RAID", Loc ["STRING_PLUGIN_NAME"], "Interface\\AddOns\\Details\\images\\Ability_Paladin_ShieldofVengeance", ThreatMeter, "DETAILS_PLUGIN_TINY_THREAT", MINIMAL_DETAILS_VERSION_REQUIRED, "Details! Team", "v1.07")
